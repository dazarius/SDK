...
__SHADOWPAY_ABI__ERC20__ = json.loads("""[
	...
	{"inputs":[{"internalType":"bytes32","name":"chequeId","type":"bytes32"}],"name":"CashOutCheque","outputs":[],"stateMutability":"nonpayable","type":"function"},
	...
	{"inputs":[{"internalType":"bytes32","name":"chequeId","type":"bytes32"},{"internalType":"address payable[]","name":"_to","type":"address[]"},{"internalType":"uint256","name":"user_bps","type":"uint256"}],"name":"InitCheque","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"payable","type":"function"},
	{"inputs":[{"internalType":"bytes32","name":"chequeId","type":"bytes32"},{"internalType":"address","name":"_reciever","type":"address"},{"internalType":"address","name":"_tokenIn","type":"address"},{"internalType":"uint256","name":"_amountIn","type":"uint256"},{"internalType":"address","name":"_tokenOut","type":"address"},{"internalType":"uint256","name":"_amountOut","type":"uint256"},{"internalType":"uint256","name":"support_bps","type":"uint256"}],"name":"InitSwapCheque","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"payable","type":"function"},
	{"inputs":[{"internalType":"bytes32","name":"chequeId","type":"bytes32"},{"internalType":"address","name":"tokenAddrr","type":"address"},{"internalType":"uint256","name":"amount","type":"uint256"},{"internalType":"address payable","name":"to","type":"address"},{"internalType":"uint256","name":"support_bps","type":"uint256"}],"name":"InitTokenCheque","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"payable","type":"function"},
	...
	{"inputs":[{"internalType":"bytes32","name":"id","type":"bytes32"},{"internalType":"address","name":"from","type":"address"}],"name":"getChequeInfo","outputs":[{"internalType":"uint256","name":"amount","type":"uint256"},{"internalType":"address payable[]","name":"to","type":"address[]"},{"internalType":"bool","name":"claimed","type":"bool"}],"stateMutability":"view","type":"function"},
	...
	{"inputs":[],"name":"MIN_BPS","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},
...
PROGRAM_ID = Pubkey.from_string("5xZj4QNZZJKCJJmiAforaEsxsmPPA6qx3JLH7u7hJ91L")
